...
CREATE INDEX idx_merged_2011 on joins.census_2011_buffered_dropna USING gist(geom);
...
\COPY (SELECT points.panoid AS panoid_2021, points.lat AS lat_2021, points.lon as lon_2021, points.idx as idx_2021, buffered.panoid AS panoid_2011, buffered.lat AS lat_2011, buffered.lon as lon_2011, buffered.idx as idx_2011 FROM merge.panoids_2021 AS points  JOIN joins.census_2011_buffered_dropna AS buffered ON ST_Contains(buffered.geom, points.geom)) TO 'outputs/2011_buffered_merge_to_2021_dropna.csv' csv header;
