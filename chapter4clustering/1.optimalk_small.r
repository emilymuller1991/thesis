...
tikzDevice::tikz(file = "/home/emily/phd/drives/phd/chapter4clustering/outputs/R/dist_centroids_resize_small3.tex", width = 4/1.9, height = 3/1.9)
...
g2
# here we open a tex file for output, and set the plots dimensions
tikzDevice::tikz(file = "/home/emily/phd/drives/phd/chapter4clustering/outputs/R/sil_score_resize_small3.tex", width =4/1.9, height = 3/1.9)
...
g3
# here we open a tex file for output, and set the plots dimensions
tikzDevice::tikz(file = "/home/emily/phd/drives/phd/chapter4clustering/outputs/R/db_score_resize_small3.tex", width = 4/1.9, height = 3/1.9)
