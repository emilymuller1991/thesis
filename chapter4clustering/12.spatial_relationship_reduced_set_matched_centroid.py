...
# meta_2011_keep.to_csv('/home/emily/phd/0_get_images/outputs/psql/census_2011/census_2011_image_meta_double_dropna_matched_centroid.csv', index=False)
...
# 454,165
# meta_2011_keep_b.to_csv('/home/emily/phd/0_get_images/outputs/psql/census_2011/census_2011_image_meta_double_dropna_b_matched_centroid.csv', index=False)
# meta_2011_keep_d.to_csv('/home/emily/phd/0_get_images/outputs/psql/census_2011/census_2011_image_meta_double_dropna_d_matched_centroid.csv', index=False)
...
# meta_2021_keep.to_csv('/home/emily/phd/0_get_images/outputs/psql/census_2021/census_2021_image_meta_double_dropna_matched_centroid.csv', index=False)
# ##################################################### SPLIT ANGLES B & D 
...
# 431,787
# meta_2021_keep_b.to_csv('/home/emily/phd/0_get_images/outputs/psql/census_2021/census_2021_image_meta_double_dropna_b_matched_centroid.csv', index=False)
# meta_2021_keep_d.to_csv('/home/emily/phd/0_get_images/outputs/psql/census_2021/census_2021_image_meta_double_dropna_d_matched_centroid.csv', index=False)

########################################################################################################## RUN SQL MERGE TO POINT
# 1. Import 2011 year to sql and run buffer with 0.00007 degrees buffer
# 2. Save as Shapefile
# 3. run shp2psql to create .sql file
##### shp2pgsql -s 4326 census_2011_buffered_00007_d_dropna_matched_centroid.shp joins.census_2011_buffered_dropna_d_matched_centroid > census_2011_buffered_dropna_d_matched_centroid.sql
##### psql -U emily -d london census_2011_buffered_dropna_d_matched_centroid.sql
##### london=# SELECT ST_Area(geom) from joins.census_2011_buffered_dropna_d_matched_centroid;
# 4. run psql to import .sql file
...
# df_2021_['clusters_2021_cleanup'] = df_2021_['clusters_2021_cleanup'].apply(lambda x: 'Low-density' if x == 'Leafy green residential' else x)
# df_2011_['clusters_2011_cleanup'] = df_2011_['clusters_2011_cleanup'].apply(lambda x: 'Low-density' if x == 'Leafy green residential' else x)
# df_2018_['clusters_2018_cleanup'] = df_2018_['clusters_2018_cleanup'].apply(lambda x: 'Low-density' if x == 'Leafy green residential' else x)
...
df_2011_oa.to_csv('chapter4clustering/outputs/2011_reduced_set_proportions_matched_centroid.csv')
df_2021_oa.to_csv('chapter4clustering/outputs/2021_reduced_set_proportions_matched_centroid.csv')

df_2011_oa.to_csv('chapter4clustering/outputs/2011_reduced_set_proportions_dropna_matched_centroid.csv')
df_2021_oa.to_csv('chapter4clustering/outputs/2021_reduced_set_proportions_dropna_matched_centroid.csv')
...
merge_all.to_csv('chapter4clustering/outputs/cluster_proportions_2011_2021_sql_absolute_lsoa_keep_interesting_matched_centroid.csv')

########################################################## SPOT CHECKS

################################################ SAVE 'E01004392' (lat,lon)
example_2021 = df_2021_[df_2021_['LSOA11CD'] == 'E01004392'].merge(meta_2021_keep, left_on='Unnamed: 0', right_on='idx_y')
example_2011 = df_2011_[df_2011_['LSOA11CD'] == 'E01004392'].merge(meta_2011_keep, left_on='Unnamed: 0', right_on='idx_y')
