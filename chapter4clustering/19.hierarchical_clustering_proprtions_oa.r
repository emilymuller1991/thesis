...
df_2011 <- read.csv('/media/emily/south/phd/chapter4clustering/outputs/2011_proportions_all_nonna_oa.csv')[,2:8]
df_2021 <- read.csv('/media/emily/south/phd/chapter4clustering/outputs/2021_proportions_all_nonna_oa.csv')[,2:8]
...
df_2011_ <- read.csv('/media/emily/south/phd/chapter4clustering/outputs/2011_proportions_all_nonna_oa.csv')
df_2021_ <- read.csv('/media/emily/south/phd/chapter4clustering/outputs/2021_proportions_all_nonna_oa.csv')
df_2011_$hierarchical8 <- cluster_groups[1:24638]
end <- 24638+24305
df_2021_$hierarchical8 <-  cluster_groups[24639:end]

write.csv(df_2011_, '/media/emily/south/phd/chapter4clustering/outputs/2011_proportions_all_nonna_oa_hierarchical13.csv')
write.csv(df_2021_, '/media/emily/south/phd/chapter4clustering/outputs/2021_proportions_all_nonna_oa_hierarchical13.csv')
