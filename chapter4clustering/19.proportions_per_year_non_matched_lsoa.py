...
df_both_years = pd.read_csv('chapter4clustering/outputs/census_2011_and_census_2021_zoom_matched.csv')
...
df_2018_oa['count'] = df_2018_class.groupby('LSOA11CD').count()['clusters_2018_cleanup_Commercial']
...
df_2011_oa.to_csv('chapter4clustering/outputs/2011_proportions_all_nonna.csv')
df_2018_oa.to_csv('chapter4clustering/outputs/2018_proportions_all_nonna.csv')
df_2021_oa.to_csv('chapter4clustering/outputs/2021_proportions_all_nonna.csv')
