...
for (perception in perceptions) {
  input <- paste0("/home/emily/phd/drives/phd/chapter5perceptions/outputs/R/change_in_deciles_",perception,'_perception.csv')
  ...
  g1
  path <- paste0("/home/emily/phd/drives/phd/chapter5perceptions/outputs/R/change_in_decile_",perception,'_perception.tex')
