...
exposures <- read.csv('/home/emily/phd/drives/phd/chapter3data/outputs/exposure_NO2a_merge_hierarchicalx.csv')
...
plot(g1)
png(filename="/home/emily/phd/drives/phd/chapter6substantive/outputs/boxplot_no2a_hierarhical8.png", width = 700, height=500)
plot(g1)
dev.off()
...
g1 <- g1 + theme(axis.text.x = element_text(angle = 45,vjust = 0.99, hjust=1))
plot(g1)
png(filename="/home/emily/phd/drives/phd/chapter6substantive/outputs/boxplot_no2a_hierarhical13.png", width = 700, height=500)
plot(g1)
dev.off()
...
g1 <- g1 + theme(axis.text.x = element_text(angle = 45,vjust = 0.99, hjust=1))
plot(g1)
png(filename="/home/emily/phd/drives/phd/chapter6substantive/outputs/boxplot_no2a_hierarhical24.png", width = 700, height=500)
plot(g1)
dev.off()
